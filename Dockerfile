...
COPY resources/postgresql-42.2.5.jar $JBOSS_HOME/modules/system/layers/base/org/postgresql/main/
COPY resources/module.xml $JBOSS_HOME/modules/system/layers/base/org/postgresql/main/
...
COPY target/lmdb.war $JBOSS_HOME/standalone/deployments/
